...
public class BeautyPhotoList {
    ...
    private List<BeautyPhotoInfo> results;
    ...
    public List<BeautyPhotoInfo> getResults() {
        return results;
    }

    public void setResults(List<BeautyPhotoInfo> results) {
